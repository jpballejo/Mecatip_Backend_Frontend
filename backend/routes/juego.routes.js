...
router.get('/:idPartida', controladorJuego.getPartidaById);
router.get('/infopartida', controladorJuego.getinfoPartidas);
router.get('/infopartida/:idPartida', controladorJuego.getInfoPartidaByIdPartida);
router.post('/altaInfoPartida', controladorJuego.crearInfoPartida);
router.post('/altaPartida', controladorJuego.altaPartida);
router.put('/modificarinfopartida/:idPartida', controladorJuego.modificarInfoPartidaById);
